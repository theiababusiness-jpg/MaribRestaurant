...
<head>
    ...
    <title>إضافة تصنيف - مطعم مأرب</title>
...
<div class="container" style="max-width:780px; margin-top:20px;">
    ...
    <!-- عنوان الصفحة -->
    <div class="card">
        <h2 class="page-title" style="margin:0;">إضافة تصنيف</h2>
    ...
    <div class="card" style="margin-top:14px;">
        <form action="{{ route('admin.categories.store') }}" method="POST" style="display:grid; gap:12px;">
            @csrf
            ...
            <div>
                ...
                <input class="input" type="text" name="slug" value="{{ old('slug') }}" placeholder="main-dishes">
